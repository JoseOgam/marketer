...
const Services = () => {
  return (
    <div>
      ...
      <div className='container-fluid mx-auto mt-5 mb-5 col-12 Services'>
    ...
    <div className="row cards">
        <div className="card col-md-3 col-12">
            <div className="card-content">
              <div className="card-body">
                <img className="img" src="https://i.imgur.com/S7FJza5.png" alt="##" />
        ...
        <div className="card col-md-3 col-12 ml-2">
            <div className="card-content">
              <div className="card-body">
                <img className="img" src="https://i.imgur.com/xUWJuHB.png" alt="##" />
        ...
        <div className="card col-md-3 col-12 ml-2">
            <div className="card-content">
              <div className="card-body">
                <img className="img rck" src="https://i.imgur.com/rG3CGn3.png" alt="##" />
